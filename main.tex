...
\noindent\blfootnote{Trabalho de Conclusão de Curso apresentado ao Instituto Nacional de Telecomunicações, como parte dos requisitos para a obtenção do Grau de Bacharel em Engenharia de Computação. Orientador: Prof. Me. Marcelo Vinícius Cysneiros Aragão. Trabalho aprovado em XX/20XX.}

\input{secoes/01-resumo.tex}
\input{secoes/02-introducao.tex}
\input{secoes/03-trabalhos-relacionados.tex}
\input{secoes/04-proposta.tex}
\input{secoes/05-ferramentas.tex}
